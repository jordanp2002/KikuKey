    ...
    <div className="flex min-h-screen">
      ...
      <div className={`flex-1 transition-all duration-300 ${isSidebarOpen ? 'ml-64' : 'ml-0'}`}>
        <div className="flex-1 w-full flex flex-col gap-8 max-w-4xl mx-auto p-6">
          <h1 className="text-4xl font-bold text-center">Japanese Writing Systems</h1>
          <div className="space-y-2">
            <h2 className="text-3xl font-bold">Japanese Writing Charts</h2>
            <p className="text-muted-foreground">Reference charts for Hiragana and Katakana writing systems.</p>
          </div>

          <div className="prose dark:prose-invert max-w-none">
            <h3 className="text-xl font-semibold mb-3 text-[#F87171]">Understanding Japanese Writing</h3>
            <div className="grid md:grid-cols-2 gap-6">
              <div className="space-y-2 p-4 rounded-xl border-2 bg-background">
                <h4 className="text-lg font-medium">Basic Structure</h4>
              ...
              <div className="space-y-2 p-4 rounded-xl border-2 bg-background">
                <h4 className="text-lg font-medium">Sound Modifications</h4>
                <p className="text-sm leading-relaxed">
          ...
          <Tabs defaultValue="hiragana" className="w-full">
            ...
            <TabsContent value="hiragana" className="mt-6">
              <div className="space-y-6">
                <h3 className="text-2xl font-semibold text-[#F87171]">Hiragana Chart</h3>
                ...
                <h4 className="text-xl font-semibold mt-8 text-[#F87171]">Dakuten and Handakuten</h4>
                <div className="relative p-4 rounded-xl border-2">
                  <div className="grid grid-cols-[60px_repeat(5,1fr)] gap-4 mb-4 text-center">
                    <div className="text-muted-foreground font-medium"></div>
                    {VOWELS.map((vowel) => (
            ...
            <TabsContent value="katakana" className="mt-6">
              <div className="space-y-6">
                <h3 className="text-2xl font-semibold text-[#F87171]">Katakana Chart</h3>
                <div className="relative p-4 rounded-xl border-2">
                  <div className="grid grid-cols-[60px_repeat(5,1fr)] gap-4 mb-4 text-center">
                    <div className="text-muted-foreground font-medium"></div>
                    {VOWELS.map((vowel) => (
