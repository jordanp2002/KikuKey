...
export default function AnkiSettingsPage() {
  ...
  const loadAnkiData = async () => {
    ...
    try {
      ...
      try {
        ...
        // Always try to load fields for the currently selected model
  ...
  // Add an effect to load fields when defaultModel changes
  useEffect(() => {
  ...
  const handleModelChange = async (modelName: string) => {
    // Just update the settings - the useEffect will handle loading the fields
